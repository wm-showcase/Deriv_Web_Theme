...
--------
To clone the Deriv_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/Deriv_Web_Theme.git
 cd Deriv_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from Deriv_Web_Theme directory
